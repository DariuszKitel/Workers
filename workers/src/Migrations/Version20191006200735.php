 ...
 */
final class Version20191006200735 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_B6F7494EF675F31B ON question (author_id)');
        $this->addSql('CREATE INDEX IDX_B6F7494E9E42BB0E ON question (work_post_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, username, password, name, email, pass_change_date, enabled, confirmation_token FROM user');
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, pass_change_date INTEGER DEFAULT NULL, enabled BOOLEAN DEFAULT \'0\' NOT NULL, confirmation_token VARCHAR(40) DEFAULT NULL)');
        $this->addSql('INSERT INTO user (id, username, password, name, email, pass_change_date, enabled, confirmation_token) SELECT id, username, password, name, email, pass_change_date, enabled, confirmation_token FROM __temp__user');
